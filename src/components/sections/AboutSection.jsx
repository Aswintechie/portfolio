...
const AboutSection = React.memo(() => {
  ...
  return (
    <section
      id='about'
      className='section-padding bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative overflow-hidden transition-colors duration-300'
    >
      ...
      <div className='container-custom relative z-10'>
        ...
        >
          ...
          <h2 className='text-4xl lg:text-5xl font-black mb-6 text-gray-900 dark:text-white'>
            <span className='bg-gradient-to-r from-gray-900 via-blue-800 to-gray-900 dark:from-blue-400 dark:via-cyan-400 dark:to-blue-400 bg-clip-text text-transparent'>
          ...
          >
            {stats.map((stat, index) => (
              <motion.div
                ...
                className='group relative bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-shadow duration-300 border border-white/20 dark:border-gray-700/50 overflow-hidden'
              >
